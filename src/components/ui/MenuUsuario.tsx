  ...
  return (
    <div ref={menuRef} className="relative">
      <button
        ...
        className="btn-feedback sombra-suave flex h-8 w-8 items-center justify-center rounded-full border border-borde bg-superficie text-texto-suave hover:bg-superficie-alta hover:text-texto"
      >
        <svg
